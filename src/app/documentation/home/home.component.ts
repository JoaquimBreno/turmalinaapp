...
export class HomeComponent {
    ...
    Para adicionar essas marcações ao seu conteúdo da web basta utilizar o vocabulário Unipt em conjunto com o Microdata. Este guia ajudará você a se familiarizar com o básico do Microdata e do Unipt, a fim de que você possa começar a marcar corretamente suas páginas web.
